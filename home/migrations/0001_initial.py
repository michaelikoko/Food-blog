# Generated by Django 4.1.5 on 2023-03-17 23:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_carousel_text', wagtail.fields.StreamField([('text', wagtail.blocks.CharBlock())], use_json_field=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('body', wagtail.fields.StreamField([('content', wagtail.blocks.StructBlock([('content_text', wagtail.blocks.TextBlock()), ('content_image', wagtail.images.blocks.ImageChooserBlock())]))], use_json_field=True)),
                ('title_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image')),
            ],
            options={
                'abstract': False,
